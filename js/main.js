...
(function() {
  ...
  if (!document.getElementById('chatFab')) {
    var chatHTML = ''
      ...
      +   '<span class="chat-fab-icon"><svg class="bot-avatar-svg" viewBox="0 0 80 80" width="40" height="40"><defs><linearGradient id="botGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#6366f1"/><stop offset="100%" stop-color="#3b82f6"/></linearGradient></defs><circle cx="40" cy="40" r="40" fill="url(#botGrad)"/><rect x="24" y="28" width="32" height="28" rx="8" fill="#fff"/><circle cx="33" cy="39" r="3.5" fill="#6366f1"/><circle cx="47" cy="39" r="3.5" fill="#6366f1"/><path d="M33 48 c2 3 12 3 14 0" stroke="#6366f1" stroke-width="2" fill="none" stroke-linecap="round"/><rect x="37" y="18" width="6" height="12" rx="3" fill="#fff"/><circle cx="40" cy="16" r="4" fill="#fff"/><rect x="16" y="36" width="8" height="10" rx="4" fill="#fff"/><rect x="56" y="36" width="8" height="10" rx="4" fill="#fff"/></svg></span>'
      +   '<span class="chat-fab-close">✕</span>'
      + '</button>'
      + '<div class="chat-window" id="chatWindow">'
      +   '<div class="chat-header">'
      +     '<span class="chat-header-avatar"><svg class="bot-avatar-svg" viewBox="0 0 80 80" width="36" height="36"><defs><linearGradient id="botGradH" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#6366f1"/><stop offset="100%" stop-color="#3b82f6"/></linearGradient></defs><circle cx="40" cy="40" r="40" fill="url(#botGradH)"/><rect x="24" y="28" width="32" height="28" rx="8" fill="#fff"/><circle cx="33" cy="39" r="3.5" fill="#6366f1"/><circle cx="47" cy="39" r="3.5" fill="#6366f1"/><path d="M33 48 c2 3 12 3 14 0" stroke="#6366f1" stroke-width="2" fill="none" stroke-linecap="round"/><rect x="37" y="18" width="6" height="12" rx="3" fill="#fff"/><circle cx="40" cy="16" r="4" fill="#fff"/><rect x="16" y="36" width="8" height="10" rx="4" fill="#fff"/><rect x="56" y="36" width="8" height="10" rx="4" fill="#fff"/></svg></span>'
